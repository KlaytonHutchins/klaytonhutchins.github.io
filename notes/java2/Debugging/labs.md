...
1. Open `Debugging/com.example.debugging.labs.BuggyProgram`.
   ...
   You must examine the class and find its bugs.
   * Do not just fix the code.
   * Do not put any `System.out.println()` statements.
   * Add breakpoints and step through the code to find the bug.
     * Start with a breakpoint in `main`, and then step into methods.
     * Add additional breakpoints in methods as you move through code.
     * Look at variable values in the _Variables_ tab.
