...
describe("Datatypes Test Suite", function() {
  describe("1: Create variables to hold the following information about a dog:", function() {
    describe("'nickname' variable", function() {
      it("'nickname' variable is defined.", function() {
        expect(nickname).to.not.be.undefined;
      });

      it("'nickname' is a string.", function() {
        expect(nickname).to.be.a('string');
      });
    });
  ...
  describe(`4: Create an array literal in a variable named 'months', add each
    ...
    it("months is declared", function() {
      expect(months).to.not.be.undefined;
    });
    it("months is an array", function() {
      expect(months).to.be.a('array');
    });
