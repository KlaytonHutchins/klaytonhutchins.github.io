...
* If someone tells you to put the letter _s_ at the end of a word, `s` is a literal value — it has no name and it represents one particular letter.
...
* `double` literals _do_ contain a decimal point: `0.0`, `3.14`, `-15.9997`.
* `char` literals are always enclosed in a pair of single quotes: `'H'`, `'k'`,
`'9'`, `'('`, `'*'`.
