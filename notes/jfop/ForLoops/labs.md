...
1. Write a program that uses a for loop to print out the first 16 multiples of 2.
   ...
   (Solution: _Pow2.java_)


2. Modify your temperature conversion program from the previous section and use a loop that will allow for 5 different temperatures to be input and converted.

   (Reference: _FahrCelsReference.java_)

   (Solution: _LoopFahrCels.java_)



4. Write a program that prints the factorials of the integers from 1 to 10. The factorial of a number N is the product of all numbers less than or equal to N: factorial 1 (1!) is just one. 2! is (1 * 2) = 2.
