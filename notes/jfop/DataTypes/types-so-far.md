...
> #### primitive data type
> A data type in Java that holds a simple data value, like a number or character. This is different than a _reference_, which holds the address of an object.
