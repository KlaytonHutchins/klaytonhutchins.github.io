...
### Drill
Launch Eclipse.  In the _Select a directory as a workspace_ dialog, change the _Workspace:_ to `/Users/YOURUSERNAMEHERE/SD/Java/workspace`.  Eclipse will create the `workspace` directory if it doesn't exist.
* Click **Launch**.
