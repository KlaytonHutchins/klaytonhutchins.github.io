...
1. Add a uni-directional, one-to-one relationship between *Store* and *Address*. Think about which entity would be the _owning entity_.

   * ***NOTE:*** For now don't do anything with the `manager_id`

1. Create a *JUnit* test for *Store* in a class named *StoreTest* within the *test* src folder.  
