...
-   Prerequisites: [Variables, assignment statements and sequences](0012.md)
...
![If-then-else template](resources/ifthenelse_template.png) 
...
![The pictorial representation of algorithm findmax2](resources/ifthenelse_max2.png)
